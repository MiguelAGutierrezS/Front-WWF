  ...
  return (
    <div className="bg-white/5 p-6 rounded-2xl border border-white/10 flex-1 flex flex-col min-w-[300px]">
      ...
      <div className="grid grid-cols-2 gap-4 flex-1">
        ...
        <div className="bg-black/20 border border-white/5 rounded-xl p-4 flex flex-col relative overflow-hidden transition-colors text-center">
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-400 to-transparent opacity-50"></div>
          <h4 className="text-gray-400 text-sm font-semibold tracking-wider uppercase mb-2">Especies (S)</h4>
          <div className="flex-1 flex items-center justify-center">
            <p className="text-4xl font-extrabold text-white">{sValue}</p>
          </div>
        </div>
        ...
        <div className="bg-black/20 border border-white/5 rounded-xl p-4 flex flex-col relative overflow-hidden transition-colors text-center">
          ...
          <h4 className="text-gray-400 text-sm font-semibold tracking-wider uppercase mb-2">Diversidad (H')</h4>
          <div className="flex-1 flex items-center justify-center">
            <p className="text-4xl font-extrabold text-white">{shannon}</p>
          </div>
        </div>
        ...
        <div className="bg-black/20 border border-white/5 rounded-xl p-4 flex flex-col relative overflow-hidden transition-colors text-center">
          ...
          <h4 className="text-gray-400 text-sm font-semibold tracking-wider uppercase mb-2">Equilibrio (D)</h4>
          <div className="flex-1 flex items-center justify-center">
            <p className="text-4xl font-extrabold text-white">{simpson}</p>
          </div>
        </div>
        ...
        <div className="bg-black/20 border border-white/5 rounded-xl p-4 flex flex-col relative overflow-hidden transition-colors text-center">
          ...
          <h4 className="text-gray-400 text-sm font-semibold tracking-wider uppercase mb-2">Dominante</h4>
          <div className="flex-1 flex items-center justify-center">
            <p className="text-2xl font-extrabold text-primary capitalize leading-tight break-words">{dominante}</p>
          </div>
        </div>
      </div>
    </div>
