...
export const ActivityPatternChart = () => {
  ...
  return (
    <div className="bg-white/5 p-4 rounded-2xl border border-white/10 flex-1 flex flex-col w-full mt-4">
      <h3 className="text-base font-bold text-white mb-2">Patrón de Actividad Diaria (Ciclo Circadiano)</h3>
      <p className="text-xs text-gray-400 mb-4">Analiza los periodos de actividad relativa a lo largo de 24 horas.</p>
          ...
          <div className="overflow-y-auto custom-scrollbar flex-1 p-2 space-y-1">
            {allSpecies.map((species) => {
              ...
              return (
                <label 
                  key={species} 
                  className={`flex items-center space-x-2 px-2 py-1 rounded-lg cursor-pointer transition-colors ${
                ...
                >
                  ...
                  <span className="capitalize text-xs truncate">{species}</span>
                </label>
              );
            })}
          </div>
