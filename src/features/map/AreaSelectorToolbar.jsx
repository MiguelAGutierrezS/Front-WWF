...
export const AreaSelectorToolbar = () => {
  ...
  return (
    <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 pointer-events-auto z-50 flex flex-col items-center">
      ...
      {/* Expanded Menu */}
      <div 
        className={`bg-black/90 backdrop-blur-xl border border-white/20 rounded-3xl p-4 shadow-2xl flex flex-col items-center mb-4 transition-all duration-500 origin-bottom ${
      ...
      >
        ...
        <div className="flex gap-4">
          <button 
            ...
            className={`flex flex-col items-center justify-center gap-2 w-24 py-4 rounded-2xl transition-all duration-300 cursor-pointer ${
          ...
          {(drawingMode || hasSelection) && (
            <button 
              ...
              className="flex flex-col items-center justify-center gap-2 w-24 py-4 rounded-2xl bg-red-500/10 border border-red-500/20 text-red-400 hover:bg-red-500/20 hover:scale-105 transition-all duration-300 cursor-pointer"
            >
              <X className="w-6 h-6" /> 
      ...
      <button
        ...
        className={`flex items-center justify-center gap-3 px-8 py-3.5 rounded-full font-extrabold text-sm transition-all duration-500 shadow-2xl cursor-pointer hover:scale-105 ${
      ...
      >
        <Crop className={`w-5 h-5 transition-transform duration-500 ${isOpen ? 'rotate-90' : ''}`} />
