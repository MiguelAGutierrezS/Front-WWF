    ...
    <AdvancedMarker position={position} zIndex={9999}>
      <div className="relative -top-12 -left-1/2 transform translate-x-1/4 animate-in zoom-in slide-in-from-bottom-2 duration-300 flex items-center gap-2">
        <button 
          ...
          className="bg-primary hover:bg-green-400 text-black font-extrabold px-6 py-3 rounded-full shadow-2xl flex items-center gap-2 whitespace-nowrap border-2 border-black/20 cursor-pointer transition-all hover:scale-105"
        >
